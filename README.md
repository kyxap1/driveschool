...
6. Дорога - обустроенная (приспособленная) и используемая для движения ТС полоса земли или поверхность искусственного сооружения.
    К дороге относятся: 
    - проезжая часть
    - трамвайный путь
...
*Полоса движения* - продольная полоса на проезжей части, обозначенная (или не обозначенная) дорожной разметкой, шириной не менее чем 2.75м, и используемая для движения нерельсовых ТС.
При отсутствии знаков или разметки, определяющих количество полос, количество полос определяется самим водителем с учетом ширины проезжей части, габаритов ТС и безопасных интервалов между ними. Двухколесные ТС на одной полосе могут двигаться в два ряда.
...
7. *Перекресток* - место пересечения, примыкания или разветвления дорог на одном уровне.
Перекресток может включать в себя одно или несколько пересечений проезжих частей.

8. *Главная дорога* - дорога с покрытием по отношению к грунтовой или обозначенная соответствующими дорожными знаками.
При однотипных покрытиях перекресток называется равнозначным. На равнозначном перекрестке приоритет имеет водитель ТС, которое приближается справа (справа автомобиль - уступи дорогу). Наличие покрытия на грунтовой дороге непосредственно перед перекрестком не делает его равнозначным. Выезд с примыкающей территории перекрестком не является.
...
27. Безопасный интервал - расстояние между боковыми частями ТС, при котором обеспечена безопасность движения.
При увеличении скорости движения боковой интервал необходимо увеличивать. Боковой интервал должен находиться в диапазоне 0.8-2.5м.
...
Водитель, участвующий в международном движении обязан иметь при себе:
    ...
    - опознавательные знаки государства, в котором зарегистрировано ТС.
    В России разрешается устанавливать опознавательные знаки на номерах.
...
1. Военная АвтоИнспекция - остановить
...
2. полиция (ГИБДД) ФСБ, ФСО - остановить, потребовать все документы, потребовать предоставить ТС
...
3. медицинские и фармацевтические работники - предоставить ТС для срочной транспортировки больного

4. паромная переправа - только остановить

5. ж/д переезд - только остановить

6. федеральная служба по надзору в сфере транспорта (Ространснадзор) - остановить, потребовать путевой лист, лицензионную карточку, документы на груз (товарно-кассовые чеки, накладные)
...
2. оказать возможную помощь пострадавшим
...
- в состоянии алкогольного, наркотического или иного опьянения, находясь под воздействием лекарственных препаратов, снижающих внимание и реакцию
...
Пешеход обязан двигаться по тротуарам, пешеходным дорожкам, а при их отсутствии - по обочине дороги (держась  правой стороны). А если обочины нету - двигаться по краю проезжей части навстречу движения ТС.

При отсутствии тротуара или пешеходной дорожки пешеход может двигаться по велодорожке, держась правой стороны, не затрудняя движения велосипедов и мопедов. Лица, переносящие громоздкие предметы или ведущие транспортное средство, должны двигаться по ходу движения.
...
При приближении спецмашин пешеход обязан воздержаться от перехода проезжей части, либо немедленно покинуть ее.

Запрещается внезапно выходить на проезжую часть, а так же задерживаться или останавливаться на ней, если это не связано с обеспечением безопасности дорожного движения.
...
Разметка бывает временной и постоянной. Временная изображается оранжевым цветом и имеет преимущество перед постоянной разметкой.
...
1.18.1  стрелочка с изображением тупика
...
- при встречном разъезде, а так же при следовании за попутным ТС не менее 150м до встречного ТС
...
- с применением гибкой сцепки (тросом).
Длина гибкого звена при такой буксировка должна быть в пределах от 4-6м.
При этом на гибком звене должно быть закреплены опознавательные щитки или флажки размером 20х20, с красно-белыми полосами числом не менее 2х, за исключением использования ленты с элементами из светоотражающего материала.
- с применением жесткой сцепки.
Такая буксировка применяется при расстоянии не более 4х метров.
...
6. прочие элементы конструкции
    ...
    - не работает противоугонное устройство
...
3. Передача пострадавшего бригаде скорой помощи или доставка пострадавшего в медицинское учреждение


Этапы оказания скорой помощи
----------------------------

- оказание помощи на месте ДТП
- оказание помощи бригадой скорой помощи
- оказание помощи медицинским учреждением


*Первая медиционская помощь* - комплекс простейших медицинских мероприятий, направленных на временное устранение причин, угрожающих жизни пораженного.
...
Существуют категории помощи: самопомощь и взаимопомощь.


Аптечка


занятие 21: 9 Июля 2015
=======================
...
*Сонная артерия*
Наложить давящую повязку, под которую подкладывают плотный валик.


*Подключичная артерия*
Пржимают к первому ребру в ямке над ключицей, если рана расположена высоко на плече или в подмышечной впадине.


*Подмышечная артерия*
Прижимают к головке ключевой кости, если рана расположена в области средней или нижней трети плеча.


*Плечевая артерия*
Прижимают к плечевой кости с внутренней стороны плеча сбоку от двухглавой мышцы, если рана в нижней трети плеча или на предплечье.


*Лучевая артерия*
Прижимают к подлежащей кости в области запястья у первого пальца при повреждении артерии кисти.


*Бедренная артерия*
Прижимают к лобковой кости таза путем надавливания кулаком.


*Подколенная артерия*
Прижимают в области подколенной ямки при кровотечении в области голени или стопы.


*Артерия тыла стопы*
Прижимают к подлежащей кости стопы
...
- с помощью закрутки
- с помощью завязывания узла
- с помощью закручивания палочки
- с помощью сгибания конечности


Виды кровотечения
-----------------

- венозное и каппилярное кровотечение
- гематозное кровотечение


*Стенокардия* (Грудная жаба)
Расстройство кровообращения в сердечной мышце.
Боли в области сердца или за грудиной, жгучие, сжимающие, отдают в шею, под лопатку, в левую руку.
Больной бледен, покрыт холодным потом, поднимается артериальное давление, может быть рвота.
Продолжительность: от нескольких минут до получаса.


*Тепловой удар*
Нарушение терморегуляции организма.
Усталость, головная боль, головокружение, покраснение кожи, рвота, шум в ушах, потемнение в глазах, одышка, посинение лица, пульс частый и слабый, судороги, потеря созания.
Помощь: переместить человека в холод, постепенно охладить голову и область сердца, дать попить холодной воды, понюхать ватку с нашатырем.


*Отравление угарным газом*
Тошнота, сердцебиение, шум в ушах, мышечная слабость, рвота, судороги и смерть от паралича дыхательного центра.
Помощь: свежий воздух, искусственное дыхание, растирание, грелка к ногам, ватка с нашатырем.


*Пищевое отравление*
Тошнота, рвота, боли в животе, бледность кожи, повышение температуры, жидкий стул
