...
При запрещающем сигнале регулировщика или светофора водитель должен остановиться 
    ...
    - перед краем пересекаемой проезжей части, при отсутствии перехода
    не препятствуя движению пешеходов
...
Противотуманные фары разрешено использовать:
    1. в условиях недостаточной видимости - только с ближним или дальним светом фар
    2. в темное время суток на неосвещенных участках дорог - только с ближним или дальним светом фар
    3. в светлое время суток вместо ближнего света фар
