...
1. тормозная система
    ...
    * не замыкается ручник в рабочем положении
    - ручник не обеспечивает неподвижное состояние
...
- суммарный люфт в рулевом управлении превышает
    ...
    грузовые автомобили                             25"
        - имеются непредусмотренные конструкцией ТС ощутимые перемещения деталей рулевого управления
            или резьбовые соединения не затянуты или не зафиксированы установленным образом
    ...
    3. двигатель
        - содержание вредных веществ в отработанных газах или их дымность превышают установленные ГОСТы
            например, выделение CO (угарного газа) не превышает нормы (0.8г/1км)
...
4. колеса и шины
    ...
    - остаточная высота рисунка протектора менее 
        ...
        грузовые        1.0 мм
        автобусы        2.0 мм
    - шины имеют местные порезы, оголяющие корд
